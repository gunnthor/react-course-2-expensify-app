...
const getVisibleExpenses = (expenses, { text, sortBy, startDate, endDate }) => {
  return expenses.filter( (expense) => {
    const startDateMatch = typeof startDate !== 'number' || startDate <= expenses.createdAt
    const endDateMatch = typeof endDate !== 'number' || endDate >= expenses.createdAt;
...
const expenseThree = store.dispatch(addExpense({description: 'Waffle', amount: 666, createdAt : 100}));
